...
| FZ-013 | Mitgliedschaft kündigen + Zugang-Deaktivierung | 1 | done | SPEC.md §3 Regel 24–26 | kuendigung.js berechnet 4-Wochen-zum-Monatsende-Enddatum; PUT /mitgliedschaften/:id/kuendigen; buchungen.js gated auf end_datum statt pauschal auf Status (Zugang bleibt bis Fristende aktiv); Kündigen-Button in MitgliederTab; commit: 7e0a1cb |
