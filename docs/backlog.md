...
| FZ-004 | Warteliste mit automatischem Nachrücken | 1 | done | SPEC.md §5 Prio 2 | Auto-Enqueue bei vollem Kurs; advanceWaitlist bei Storno; Email via mail.js; re-numbering; commit: pending |
