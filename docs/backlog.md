...
| FZ-009 | Trainer-Zugang (Termine + Teilnehmerliste + Check-in) | 1 | done | SPEC.md §1 Trainer | TrainerPage.jsx: Namensauswahl statt Login, eigene Termine, Teilnehmerliste + Check-in/No-Show; neue Route GET /trainer/:id/kurstermine/:kursterminId/teilnehmer liefert nur Name+Status (kein Zugriff auf Zahlungen/Kontaktdaten), 403 bei fremdem Termin |
