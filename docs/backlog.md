...
| FZ-012 | Mitgliedschaft pausieren | 1 | done | SPEC.md §3 Regel 22–23 | PUT /mitgliedschaften/:id/pausieren (90-Tage-Kumulativlimit/Kalenderjahr) + /fortsetzen; pause.js beendet abgelaufene Pausen automatisch; Pausieren/Fortsetzen-UI in MitgliederTab; Buchungssperre + SEPA-Ausschluss waren bereits vorhanden |
